/* UI Kit — Primitives. Icons, brand mark, sample data. */
...
const ICON_PATHS = {
  ...
  searchX: <><circle cx="11" cy="11" r="8"/><line x1="8" y1="8" x2="14" y2="14"/><line x1="14" y1="8" x2="8" y2="14"/></>,
  ...
  listPlus: <><path d="M11 12H3"/><path d="M16 6H3"/><path d="M11 18H3"/><path d="M15 18h6"/><path d="M18 15v6"/></>,
  listX: <><path d="M11 12H3"/><path d="M16 6H3"/><path d="M11 18H3"/><path d="m17 17 4-4"/><path d="m17 13 4 4"/></>,
...
// ──────────────── Sample data (real songs from src/data/songs/*) ────────────────
const SAMPLE_SONGS = [
  { id: "vandana", title: "Vandana", artist: "Ankit Sajwan Ministries", church: "FOLJ Church",
    ...
    lyrics: {
      hinglish: {
        ...
        chorus: "Yeshu mahima Teri mahima\nMere Raja Yeshua gaoon Teri mahima (x2)",
      ...
      hindi: {
        ...
        chorus: "येशु महिमा तेरी महिमा\nमेरे राजा येशुआ गाऊँ तेरी महिमा (x2)",
  ...
  { id: "yeshua-hamashiach", title: "Yeshua Hamashiach", artist: "Sheldon Bangera", church: "Nations of Worship",
    languages_available: ["hinglish","hindi"],
    lyrics: { hinglish: { chorus: "Yeshua Hamashiach\nTu hai mera Prabhu\nYeshua Hamashiach\nTeri mahima sada" },
              hindi: { chorus: "येशुआ हमशीयाख\nतू है मेरा प्रभु\nयेशुआ हमशीयाख\nतेरी महिमा सदा" } } },
  { id: "rang-liya", title: "Rang Liya", artist: "Ankit Sajwan Ministries", church: "FOLJ Church",
    languages_available: ["hinglish","hindi"],
  ...
  { id: "haq-tala", title: "Haq Tala", artist: "Anil Kant", church: null,
    languages_available: ["hinglish","hindi"],
    lyrics: { hinglish: { chorus: "Haq Tala, Haq Tala\nTera naam Haq Tala" },
              hindi: { chorus: "हक़ तआला, हक़ तआला\nतेरा नाम हक़ तआला" } } },
  { id: "deewana", title: "Deewana", artist: "Yeshua Band", church: "Nations of Worship",
    languages_available: ["hinglish","hindi"],
    lyrics: { hinglish: { chorus: "Tere pyaar mein deewana ho gaya\nYeshua, Yeshua mera" },
              hindi: { chorus: "तेरे प्यार में दीवाना हो गया\nयेशुआ, येशुआ मेरा" } } },
  { id: "khazana", title: "Khazana", artist: "Bridge Music", church: null,
    languages_available: ["hinglish","hindi"],
    lyrics: { hinglish: { chorus: "Tera prem hai mera khazana\nDuniya na de sake jo paayega" },
              hindi: { chorus: "तेरा प्रेम है मेरा ख़ज़ाना\nदुनिया ना दे सके जो पाएगा" } } },
  { id: "aasha-meri", title: "Aasha Meri", artist: "Bridge Music", church: null,
    languages_available: ["hinglish","hindi"],
    lyrics: { hinglish: { chorus: "Aasha meri, Yeshu hai mera\nTeri ore main aaonga sada" },
              hindi: { chorus: "आशा मेरी, येशु है मेरा\nतेरी ओर मैं आऊँगा सदा" } } },
];
...
// Ministries (mirrors src/lib/ministries.ts — abbreviated)
const MINISTRIES = [
  { slug: "icm",                  name: "Isus Christos Ministries (ICM)", short: "ICM",                  filterValue: "ICM",                     filterBy: "church" },
  { slug: "nations-of-worship",   name: "Nations of Worship",             short: "Nations of Worship",   filterValue: "Nations of Worship",      filterBy: "church" },
  { slug: "ankit-sajwan",         name: "Ankit Sajwan Ministries",        short: "Ankit Sajwan",         filterValue: "Ankit Sajwan Ministries", filterBy: "artist" },
  { slug: "yeshua-band",          name: "Yeshua Band",                    short: "Yeshua Band",          filterValue: "Yeshua Band",             filterBy: "artist" },
  { slug: "sheldon-bangera",      name: "Sheldon Bangera",                short: "Sheldon Bangera",      filterValue: "Sheldon Bangera",         filterBy: "artist" },
  { slug: "anil-kant",            name: "Anil Kant",                      short: "Anil Kant",            filterValue: "Anil Kant",               filterBy: "artist" },
  { slug: "bridge-music",         name: "Bridge Music",                   short: "Bridge Music",         filterValue: "Bridge Music",            filterBy: "artist" },
];

Object.assign(window, { Icon, Star, SAMPLE_SONGS, SAMPLE_VERSE, MINISTRIES });
